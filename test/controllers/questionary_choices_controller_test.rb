...
class QuestionaryChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionary_choice" do
    assert_difference('QuestionaryChoice.count') do
      post questionary_choices_url, params: { questionary_choice: { content: @questionary_choice.content, questionary_item: @questionary_choice.questionary_item, value: @questionary_choice.value } }
    end
  ...
  test "should update questionary_choice" do
    patch questionary_choice_url(@questionary_choice), params: { questionary_choice: { content: @questionary_choice.content, questionary_item: @questionary_choice.questionary_item, value: @questionary_choice.value } }
